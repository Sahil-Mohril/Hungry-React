...
export default function Calendar() {
    ...
    return (<div>
        <Routes>
            {/* <CreateMeal date={dateopen} month={month} year={year} /> */}
            {<Route path="/createmeal" element={<CreateMeal date={dateopen} month={month} year={year} />} />}
        </Routes>
        ...
        <div className="Month">
            ...
            {openMenu[0] && (<div className="Week-menu Week1">
                ...
                <Link to='/createmeal'> <div className="add">+</div></Link>
            </div>)}
            ...
            {openMenu[2] && (<div className="Week-menu Week2 ">
                <div className=" today">
                    <p className="selecteddate">{dateopen}th {monthname[month]}</p>
                    <p className="selectedyear">{year}</p>
                </div>
            ...
            {openMenu[3] && (<div className="Week-menu Week2 ">
                <div className=" today">
                    <p className="selecteddate">{dateopen}th {monthname[month]}</p>
                    <p className="selectedyear">{year}</p>
                </div>
            ...
            {openMenu[4] && (<div className="Week-menu Week1">
                <div className=" today">
                    <p className="selecteddate">{dateopen}th {monthname[month]}</p>
                    <p className="selectedyear">{year}</p>
                </div>
            ...
            {openMenu[5] && (<div className="Week-menu Week1">
                <div className=" today">
                    <p className="selecteddate">{dateopen}th {monthname[month]}</p>
                    <p className="selectedyear">{year}</p>
                </div>
        ...
        <button className="butt">Apply to all Months</button>
        <button className="butt">Reset All</button>
        <div className="bill">
            <h2>Bill Summary</h2>
        </div>
    </div>)
